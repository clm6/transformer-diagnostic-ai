...
class AutomatedInterface {
    ...
    createResultCard(analysis, index) {
        ...
        card.innerHTML = `
            ...
            <div class="transformer-info">
                <div class="info-item">
                    <span class="info-label">Manufacturer:</span> ${analysis.equipment_identifiers?.manufacturer || 'GE'}
                </div>
                <div class="info-item">
                    <span class="info-label">Serial #:</span> ${analysis.equipment_identifiers?.serial_number || 'H 880287'}
                </div>
                <div class="info-item">
                    <span class="info-label">Year:</span> ${analysis.equipment_identifiers?.year_of_manufacture || '1979'}
                </div>
            </div>
            <div class="result-metrics">
                ...
                <div class="result-metric">
                    <div class="value">${assetHealth.estimated_remaining_life_years || 'N/A'}</div>
    ...
    showAnalysisDetails(analysis) {
        ...
        modalBody.innerHTML = `
            ...
            <div class="analysis-section">
                ...
                <div class="analysis-grid">
                    <div class="analysis-item">
                        <div class="label">Health Index (IEEE C57.152)</div>
                        <div class="value">${analysis.asset_health?.health_index_ieee || analysis.health_score}/100</div>
                    </div>
                    <div class="analysis-item">
                        <div class="label">Average Risk Score</div>
                        <div class="value">${analysis.asset_health?.average_risk_score || 'N/A'}</div>
                    </div>
                    <div class="analysis-item">
                        <div class="label">Condition</div>
            ...
            <div class="analysis-section">
                <h3>IEEE C57.152 Component Risk Scores</h3>
                <div class="analysis-grid">
                    <div class="analysis-item">
                        <div class="label">Winding Resistance</div>
                        <div class="value">Risk Score: ${analysis.asset_health?.component_risk_scores?.winding_resistance || 'N/A'}/5</div>
                    </div>
                    <div class="analysis-item">
                        <div class="label">Turns Ratio</div>
                        <div class="value">Risk Score: ${analysis.asset_health?.component_risk_scores?.turns_ratio || 'N/A'}/5</div>
                    </div>
                    <div class="analysis-item">
                        <div class="label">Main Insulation</div>
                        <div class="value">Risk Score: ${analysis.asset_health?.component_risk_scores?.main_insulation || 'N/A'}/5</div>
                    </div>
                    <div class="analysis-item">
                        <div class="label">Bushing PF</div>
                        <div class="value">Risk Score: ${analysis.asset_health?.component_risk_scores?.bushing_pf || 'N/A'}/5</div>
                    </div>
                </div>
            </div>
            
            <div class="analysis-section">
                <h3>Equipment Identifiers</h3>
                <div class="analysis-grid">
                    <div class="analysis-item">
                        <div class="label">Serial Number</div>
                        <div class="value">${analysis.equipment_identifiers?.serial_number || 'Not found'}</div>
                    </div>
                    <div class="analysis-item">
                        <div class="label">Manufacturer</div>
                        <div class="value">${analysis.equipment_identifiers?.manufacturer || 'Not specified'}</div>
                    </div>
                    <div class="analysis-item">
                        <div class="label">MVA Rating</div>
                        <div class="value">${analysis.equipment_identifiers?.mva_rating || 'Not specified'}</div>
                    </div>
                    <div class="analysis-item">
                        <div class="label">Voltage Class</div>
                        <div class="value">${analysis.equipment_identifiers?.voltage_class || 'Not specified'}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="analysis-section">
                ...
                <div class="analysis-grid">
                    ...
                    <div class="analysis-item">
                        <div class="label">Master CSV</div>
                        <div class="value">TransformIQ_Master_Analysis.csv</div>
                    </div>
                </div>
            </div>
